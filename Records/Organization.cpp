...
void Organization::initialize()
{
	...
	AbsDirectoryComponent& fy2022_etats_financiers_liasse = sept2022_CAF.addDirectoryComponent(GenericDocument("Etats financiers 2021-2022", "2022-09-28", "Etats financiers - PDF"));
	...
	AbsDirectoryComponent& nov2022_S = m_register.addDirectoryComponent(Directory("Reunion du Senat du 15 novembre 2022"));
	AbsDirectoryComponent& nov2022_S_OJ = nov2022_S.addDirectoryComponent(Agenda("OK 2022-11-15", "2022-11-15"));
	AbsDirectoryComponent& charte_etudiant = nov2022_S.addDirectoryComponent(GenericDocument("Proposition de charte de l'etudiant", "2022-11-11", "PDF"));
